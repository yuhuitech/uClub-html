...
<head>
    ...
    <style>
        .newStyle { margin: 0 0 0 0px; border-left: 0px solid #e8e8e8; overflow:
                visible; padding: 10px 3px; }
        .timeline h2.title:before { position: absolute;
                                                  left: -23px;
                                                  top: 3px;
                                                  display: block;
                                                  width: 3px;
            ...
            <div class="nav_menu" id="pageSize">
                <nav>
                    ...
                    <%--<ul class="nav navbar-nav navbar-right">--%>
                        <%--<li class="" id="miniMenu" style="display: inline;">--%>
                            ...
                            <%--</ul>--%>
                        <%--</li>--%>
                        <%--<li role="presentation" class="dropdown" id="messageDropDown" style="display: inline;">--%>
