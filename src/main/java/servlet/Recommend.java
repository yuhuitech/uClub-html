...
//                HttpSession sessionReal = request.getSession();
//                List<Activity> list = DAO.selectAllActivity(sqlSessionFactory, userID);
//                sessionReal.setAttribute("UserNo", userID);
//                sessionReal.setAttribute("Status", status);
//                response.setContentType("text/html;charset=\"utf-8\"");
...
//                    active_Recommend.add(RecordOperations.getActiveDetail(sqlSessionFactory, i));
//                }
//
//                //活动推荐结束
//
...
//                request.setAttribute("messages", messgaes);
                ...
                request.getRequestDispatcher("/jsp/apply_center.jsp").forward(request,response);
                //跳转到推荐页面
