...
public class ApplyClubServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        selectStuName = DAO.getStudentName(sqlSessionFactory,userID);
        selectCollege = DAO.getCollege(sqlSessionFactory,userID);
        ...
        if (clubName==null&&clubInfo ==null&&clubSize==null){
            ...
            if (sqlSessionFactory != null && applyNo != 0 && clubName != "" && clubType != "" &&
                ...
                int addResult = DAO.addClubApply(sqlSessionFactory, applyNo, clubName, clubType, clubInfo, stuNo, clubSize, applyTime);
                //判断addResult给出提交结果
                if (addResult == -1) {
        ...
        RequestDispatcher view = req.getRequestDispatcher("formWizards.jsp");
