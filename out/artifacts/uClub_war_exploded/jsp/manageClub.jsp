...
<head>
    ...
    <script>
        ...
        function show_modal() {
            $('#myModal').modal('show');
            document.getElementById("clubNo").value = temp.toString();
        }
...
<div id="container" class="col-sm-offset-2 col-md-8">
    ...
    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <form action="manageClub.jsp?status=1" method="post" enctype = "multipart/form-data">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" id="btn_submit" class="btn btn-primary" onclick="winclose();"><span class="glyphicon glyphicon-ok" aria-hidden="true" ></span> 修改</button>
                    </div>
                </div>
            </form>
        </div>
